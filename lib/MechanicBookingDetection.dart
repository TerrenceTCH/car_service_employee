...
class MechanicBookingDetection extends StatefulWidget {
  const MechanicBookingDetection({Key? key}) : super(key: key);

  @override
  State<MechanicBookingDetection> createState() => _MechanicBookingDetectionState();
}

class _MechanicBookingDetectionState extends State<MechanicBookingDetection> with WidgetsBindingObserver {
  ...
  Future<void> _scanImage() async
  {
    ...
    try
    {
      ...
      await navigator.push(MaterialPageRoute(builder: (context) => MechanicBookingDetectionResult(text: combinedString)));
    }
    catch(e)
    {
      print(e.toString());
