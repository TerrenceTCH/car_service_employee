...
import 'MechanicConfirmBookingDetails.dart';
import 'bookingObject.dart';
class MechanicConfirmBookingDetectionResult extends StatefulWidget {
  const MechanicConfirmBookingDetectionResult({Key? key, required this.text}) : super(key: key);
  final String text;
  @override
  State<MechanicConfirmBookingDetectionResult> createState() => _MechanicConfirmBookingDetectionResultState();
}

class _MechanicConfirmBookingDetectionResultState extends State<MechanicConfirmBookingDetectionResult> {
  String? CarPlate;
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.pushAndRemoveUntil(context,MaterialPageRoute(builder: (content) => MechanicConfirmBookingDetails(booking: obj)), (route) => false);
